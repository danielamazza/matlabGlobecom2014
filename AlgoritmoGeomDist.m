...
% posiziono casualmente N dispositivi che richiedono una app casuale
    for j=1:N       
        ...
        for rat = RAT
            ...
            cont = cont + 1; % contatore delle RAT
        ...
        % aggiorno la RAT scelta con un dispositivo collegato in più
...
hold on;
loglog(NMD,Egd_m(NMD),'k-*','MarkerFaceColor','m','MarkerEdgeColor','m')
...
hold on;
loglog(NMD,Tgd_m(NMD),'k-*','MarkerFaceColor','m','MarkerEdgeColor','m')
...
hold on;
loglog(NMD,Sgd_m(NMD),'k-*','MarkerFaceColor','m','MarkerEdgeColor','m' )
